...
# we always keep ythe S1 data
GLOBAL_MEAN_BANDS_TO_USE = [GLOBAL_MEAN_BANDS[idx] for idx in S2_BANDS_TO_USE] + GLOBAL_MEAN_BANDS[-2:]
...
GLOBAL_STD_BANDS_TO_USE = [GLOBAL_STD_BANDS[idx] for idx in S2_BANDS_TO_USE] + GLOBAL_STD_BANDS[-2:]
